  ...
  (function($, window) {
    ...
    Plugin = (function() {
      ...
      Plugin.prototype.init = function() {
        ...
        return this.element.on('click', this.resizestart);
      };

      Plugin.prototype.resizestart = function(ev) {
        var res;
        if ($(ev.target).data('dragging')) {
          return;
        }
        res = $(this).data('resizing') === 1 ? 0 : 1;
        $(this).data('resizing', res);
        return console.log($(this).data('resizing'));
      };
