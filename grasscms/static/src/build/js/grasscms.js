...
(function() {
  var PageEditor, PersistentGrass, Ruler, SimpleHtml5Editor, Sortable, assign_input_events_to_object, assign_toolbar_events, changed_input, contextual_menu, delete_, drop, getCurrentElement, getFromMenu, recover_mobility, setCss, setup_menu, setup_toolbar, stoppropagation, update_toolbar;
  ...
  PersistentGrass = (function() {
    ...
    PersistentGrass.prototype.do_resizable = function() {
      ...
      return this.element = (($(this.element_)).wrap('<div style="position:absolute; width:' + width + '; height:' + height + '" class="resizable" data-offset="' + this.options.offset + '">')).parent();
    };
